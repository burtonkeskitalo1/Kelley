...
/** Caveats and one-off anomalies, in the provider's own words from Airtable. */
export function FinancingNotes({ rows }: { rows: FinancingRow[] }) {
      ...
      <table>
        <thead>
          <tr>
            ...
            <th scope="col" className="notes-head">
              Notes
            </th>
          </tr>
        </thead>
